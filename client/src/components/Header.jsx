  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative' >
        ...
        <div className='text-center mt-20 mb-8' >
            ...
            font-semibold sm:leading-16 text-gray-700' > <span className='text-primary' >An AI powered</span> 
            <br />Blogging Platform.</h1>
            <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500' >
                Harness AI to craft high-quality blogs effortlessly.Transform your ideas into engaging content.
                Write smarter, faster and elevate your content strategy with AI-powered assistance
            </p>
            ...
            border border-gray-300 bg-white rounded overflow-hidden' >
                <input ref={inputRef} type="text" placeholder='Search for interesting blogs' required 
